...
const SignOutButton = ({ className, style, }) => {
    ...
    return (_jsx("button", { css: {
        ...
        }, className: className, style: style, onClick: () => signOut(), children: _jsx(ButtonContentOrLoader, { authStatus: authStatus, displayMode: effectiveDisplayMode, userActionStarted: userActionStarted, children: "Sign Out" }) }));
};
